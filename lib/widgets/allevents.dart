  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children:[
        ...
        ListView.builder(itemBuilder: (context, index) => EventBox(_events[index]),itemCount: _events.length,shrinkWrap: true,physics: const NeverScrollableScrollPhysics(),padding: EdgeInsets.fromLTRB(0,10,0,0),),
      ],
    );
  }
}